package com.crs.crstemplate.commons;

import com.google.common.collect.Lists;
import com.crs.crstemplate.commons.enumeration.FieldType;
import com.crs.crstemplate.commons.enumeration.ValueEnum;
import com.crs.crstemplate.service.variable.SystemVariableService;
...
public class VariableUtils {
    ...
    /**
     * 通过{@link com.crs.crstemplate.commons.enumeration.ValueEnum} 接口子类 class 获取数据字典集合
     *
     ...
     *
     * @param value 值
     * @param className 类名称,参考{@link com.crs.crstemplate.commons.enumeration.FieldType}
     *
     * @return 转换好的值
     */
