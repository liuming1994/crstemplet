package com.crs.crstemplate.commons.valid;

import com.crs.crstemplate.commons.valid.annotation.MapValid;
import com.crs.map.validation.MapValidation;
import com.crs.map.validation.ValidError;
...
public class MapValidManager {
    ...
    @Before("execution(* com.crs.crstemplate.service.*..*(..))")
